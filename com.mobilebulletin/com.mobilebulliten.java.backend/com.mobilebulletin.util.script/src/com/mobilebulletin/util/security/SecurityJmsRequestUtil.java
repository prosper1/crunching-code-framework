...
public class SecurityJmsRequestUtil extends JmsRequestUtil{
	...
	public SecurityJmsRequestUtil(List<String> replyRequestObjects,
	...
	public static void main(String[] args) {
		SecurityJmsRequestUtil outletPurposeJmsUtil = new SecurityJmsRequestUtil(constractList(),_PACKAGE_LINE,_PATH_LINE,_CLASS_NAME_LINE,_REQUEST_PACKAGE_IMPORT);
