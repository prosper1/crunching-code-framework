...
public class SecurityTestUtil extends TestUtil{
	...
	public SecurityTestUtil(List<String> replyRequestObjects, String packageName,
	...
	public static void main(String[] args) {
		SecurityTestUtil jmsUtil = new SecurityTestUtil(constractList(),_PACKAGE_LINE,_PATH_LINE,_CATEGORY_LINE,
