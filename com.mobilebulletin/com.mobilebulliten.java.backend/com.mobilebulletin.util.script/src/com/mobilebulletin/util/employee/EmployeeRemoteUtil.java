...
public class EmployeeRemoteUtil extends RemoteUtil{ 
	private static String _PACKAGE_LINE = "package com.mobilebulletin.remote.employee;";
	private static String _PATH_LINE = "/opt/crunching-code-framework/com.mobilebulletin/com.mobilebulliten.java.backend/com.mobilebulletin.remote.service/ejbModule/com/mobilebulletin/remote/employee";
	...
	public EmployeeRemoteUtil(List<String> replyRequestObjects, String packageName,
	...
	public static void main(String[] args) {
		EmployeeRemoteUtil jmsUtil = new EmployeeRemoteUtil(constractList(),_PACKAGE_LINE,_PATH_LINE,_CATEGORY_LINE,
