...
public class EmployeeTestUtil extends TestUtil{
	...
	public EmployeeTestUtil(List<String> replyRequestObjects, String packageName,
	...
	public static void main(String[] args) {
		EmployeeTestUtil jmsUtil = new EmployeeTestUtil(constractList(),_PACKAGE_LINE,_PATH_LINE,_CATEGORY_LINE,
