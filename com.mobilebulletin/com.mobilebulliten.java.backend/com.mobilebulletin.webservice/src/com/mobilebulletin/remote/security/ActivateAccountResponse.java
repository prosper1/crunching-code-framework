...
public class ActivateAccountResponse  extends com.mobilebulletin.remote.security.SystemSuperResponse  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://security.remote.mobilebulletin.com/", "activateAccountResponse"));
    }
