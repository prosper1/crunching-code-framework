...
public class ActivateAccountRequest  extends com.mobilebulletin.remote.security.CommonRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://security.remote.mobilebulletin.com/", "activateAccountRequest"));
    }
